...
class VideoBottomControlsView extends StatefulWidget {
  final VideoPlayerController _controller;
  final double height;
  final bool autoPlay;

  VideoBottomControlsView(this.height, this._controller,
      {this.autoPlay = false});

  @override
  _VideoBottomControlsViewState createState() =>
      _VideoBottomControlsViewState();
}

class _VideoBottomControlsViewState extends State<VideoBottomControlsView> {
  VideoPlayerValue _lastestValue;
  bool _showLoading = false;
  bool _showCenterPlayBtn = true;
  ...
  void _togglePlay() {
    if (_lastestValue != null && _lastestValue.initialized) {
      setState(() {
        _showCenterPlayBtn = _lastestValue.isPlaying;
      });
            ...
            child: new Row(
              ...
              children: <Widget>[
                new GestureDetector(
                  onTap: _togglePlay,
                  child: new Icon(
                    _lastestValue != null && _lastestValue.isPlaying
                        ? Icons.pause
                        : Icons.play_arrow,
                    color: Colors.white,
                    size: 25,
                ...
                new Padding(
                  ...
                  child: new Text(
                    StringUtil.formatDuration(
                        _lastestValue != null && _lastestValue.position != null
                ...
                new Padding(
                  ...
                  child: new Text(
                    StringUtil.formatDuration(
                        _lastestValue != null && _lastestValue.duration != null
